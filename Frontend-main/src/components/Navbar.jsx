...
export default function Navbar({
  ...
  return (
    <motion.nav
      ...
      className="sticky top-0 z-50 border-b border-slate-200/80 bg-[radial-gradient(circle_at_top,_#eff7ff_0%,_#ffffff_55%)] backdrop-blur-xl shadow-sm"
    >
        ...
        <div className="ml-auto flex w-full items-center justify-end gap-3 sm:w-auto">
          <div className="relative w-full sm:w-72">
            ...
            <input
              ...
              className="w-full rounded-full border border-slate-200 bg-slate-100 py-2.5 pl-10 pr-4 text-sm text-slate-700 placeholder:text-slate-400 transition focus:border-cyan-300 focus:bg-white focus:outline-none"
            />
          ...
          {user ? (
            ...
            <button
              onClick={onOpenAuth}
              className="inline-flex items-center gap-3 rounded-full border border-slate-200 bg-gradient-to-r from-sky-100 to-cyan-100 px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-sky-100"
            >
