...
export default function Assessment() {
  ...
  const startQuestionTransition = (direction) => {
  ...
  const handleNext = async () => {
    if (!currentQuestion || !currentAnswer?.trim() || !testSessionId || isTransitioning || isSubmitting) return;
    setError("");
