    ...
    <section className={`px-4 py-5 sm:px-5 lg:px-7 ${isDark ? "bg-slate-950" : "bg-[radial-gradient(circle_at_top,_#eef6ff_0%,_#f7fbff_50%,_#ffffff_100%)]"}`}>
      <div className="mx-auto grid max-w-[1100px] gap-5 xl:grid-cols-[1.05fr_0.95fr]">
        <div className={`rounded-[25px] px-5 py-6 sm:px-6 sm:py-7 lg:py-8 ${
          ...
          <div className="mt-7 flex flex-row items-center gap-3.5 flex-nowrap">
            <button
              onClick={onStartDiscovery}
              className={`cc-display flex min-w-0 flex-1 items-center justify-center gap-2.5 rounded-full px-6 py-3 text-base font-bold transition ${
                isDark
            ...
            <button
              ...
              className={`cc-display flex min-w-0 items-center justify-center gap-2.5 rounded-full px-5 py-3 text-base font-bold transition ${
                isDark
