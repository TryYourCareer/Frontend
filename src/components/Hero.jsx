...
export default function Hero({ onStartDiscovery, onExploreCareers, careersCount = 0, isDark = true }) {
  ...
  return (
    <section className="relative overflow-visible font-sans">
      {/* ── Hero Banner ──────────────────────────────────────────────────────── */}
      <HeroBanner
        isDark={isDark}
            ...
            >
              <div className="flex flex-wrap justify-center gap-2.5 max-w-xs">
                <motion.span
                  ...
                  animate="show"
                  custom={0}
                  className="px-5 py-2.5 rounded-full text-xs font-bold bg-amber-100 dark:bg-amber-500/20 text-amber-950 dark:text-amber-300 border border-amber-300 dark:border-amber-500/40 shadow-xs"
                >
                  Interests
                </motion.span>
                ...
                <motion.span
                  ...
                  animate="show"
                  custom={1}
                  className="px-5 py-2.5 rounded-full text-xs font-bold bg-[#EAF2FA] dark:bg-blue-500/20 text-[#0b1a36] dark:text-blue-300 border border-[#D3E3F5] dark:border-blue-500/40 shadow-xs"
                >
                  Personality
                </motion.span>
              </div>
              ...
              <div className="flex justify-center">
                <motion.span
                  ...
                  animate="show"
                  custom={4}
                  className="px-5 py-2.5 rounded-full text-xs font-bold bg-emerald-100 dark:bg-emerald-500/20 text-emerald-950 dark:text-emerald-300 border border-emerald-300 dark:border-emerald-500/30 shadow-xs"
                >
                  Skills preferences
                </motion.span>
              </div>
          ...
          {activeStep === 1 && (
            ...
            >
              ...
              <motion.div
                ...
                animate="show"
                custom={1}
                className="absolute top-0 left-1 z-20 bg-white dark:bg-slate-900 text-[#0B1A36] dark:text-slate-100 text-[10px] font-bold px-3 py-1.5 rounded-full shadow-md border border-[#D3E3F5] dark:border-slate-800"
              >
                Analytical 92%
              </motion.div>
              ...
              <motion.div
                ...
                animate="show"
                custom={2}
                className="absolute top-1 right-1 z-20 bg-white dark:bg-slate-900 text-[#0B1A36] dark:text-slate-100 text-[10px] font-bold px-3 py-1.5 rounded-full shadow-md border border-[#D3E3F5] dark:border-slate-800"
              >
                Creative Fit 98%
              </motion.div>
              ...
              <motion.div
                ...
                animate="show"
                custom={3}
                className="absolute bottom-2 left-2 z-20 bg-white dark:bg-slate-900 text-[#0B1A36] dark:text-slate-100 text-[10px] font-bold px-3 py-1.5 rounded-full shadow-md border border-[#D3E3F5] dark:border-slate-800"
              >
                Leadership 88%
              </motion.div>
              ...
              <motion.div
                ...
                animate="show"
                custom={4}
                className="absolute bottom-1 right-2 z-20 bg-white dark:bg-slate-900 text-[#0B1A36] dark:text-slate-100 text-[10px] font-bold px-3 py-1.5 rounded-full shadow-md border border-[#D3E3F5] dark:border-slate-800"
              >
                Strategic 95%
              </motion.div>
              ...
              <motion.div
                ...
                animate="show"
                custom={5}
                className="absolute top-20 -left-4 z-20 bg-sky-50 dark:bg-blue-900/40 text-[#1E88E5] dark:text-blue-200 text-[9px] font-extrabold px-2.5 py-1 rounded-full shadow border border-sky-200 dark:border-blue-800"
              >
                Problem Solver
              </motion.div>
            </motion.div>
          ...
          {activeStep === 2 && (
            ...
            >
              ...
              <motion.div
                ...
                animate="show"
                custom={3}
                className="absolute top-0 left-0 bg-white dark:bg-slate-900 text-[#0B1A36] dark:text-slate-100 text-[10px] font-bold px-3 py-1.5 rounded-2xl shadow-md border border-[#D3E3F5] dark:border-slate-800"
              >
                Data Scientist ⭐⭐⭐⭐
              </motion.div>
              ...
              <motion.div
                ...
                animate="show"
                custom={4}
                className="absolute bottom-0 right-0 bg-white dark:bg-slate-900 text-[#0B1A36] dark:text-slate-100 text-[10px] font-bold px-3 py-1.5 rounded-2xl shadow-md border border-[#D3E3F5] dark:border-slate-800"
              >
                Product Manager ⭐⭐⭐⭐
              </motion.div>
            </motion.div>
          ...
          {activeStep === 3 && (
            ...
            >
              ...
              <motion.div
                ...
                animate="show"
                custom={1}
                className="absolute top-0 z-30 bg-white/95 dark:bg-slate-900/95 border border-[#D3E3F5] dark:border-slate-800 rounded-xl px-2.5 py-1 text-left shadow-lg text-[10px]"
              >
              ...
              <motion.div
                ...
                animate="show"
                custom={2}
                className="absolute top-10 left-0 z-30 bg-white/95 dark:bg-slate-900/95 border border-[#D3E3F5] dark:border-slate-800 rounded-xl px-2.5 py-1 text-left shadow-lg text-[10px]"
              >
              ...
              <motion.div
                ...
                animate="show"
                custom={3}
                className="absolute bottom-6 left-1 z-30 bg-white/95 dark:bg-slate-900/95 border border-[#D3E3F5] dark:border-slate-800 rounded-xl px-2.5 py-1 text-left shadow-lg text-[10px]"
              >
              ...
              <motion.div
                ...
                animate="show"
                custom={4}
                className="absolute -bottom-2 z-30 bg-white/95 dark:bg-slate-900/95 border border-[#D3E3F5] dark:border-slate-800 rounded-xl px-2.5 py-1 text-left shadow-lg text-[10px]"
              >
              ...
              <motion.div
                ...
                animate="show"
                custom={5}
                className="absolute top-12 right-8 z-30 bg-white/95 dark:bg-slate-900/95 border border-[#D3E3F5] dark:border-slate-800 rounded-xl px-2.5 py-1 text-left shadow-lg text-[10px]"
              >
              ...
              <motion.div
                ...
                animate="show"
                custom={6}
                className="absolute top-3 right-0 z-30 bg-white/95 dark:bg-slate-900/95 border border-[#D3E3F5] dark:border-slate-800 rounded-xl px-2.5 py-1 text-left shadow-lg text-[10px]"
              >
              ...
              <motion.div
                ...
                animate="show"
                custom={7}
                className="absolute bottom-8 right-1 z-30 bg-white/95 dark:bg-slate-900/95 border border-[#D3E3F5] dark:border-slate-800 rounded-xl px-2.5 py-1 text-left shadow-lg text-[10px]"
              >
      ...
      <div className="mx-auto max-w-6xl relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className={`inline-flex items-center gap-2 rounded-full border px-4 py-1.5 text-xs font-bold tracking-wider uppercase ${
                isDark
                  ...
                  : "border-sky-200 bg-white/80 text-[#1E88E5]"
              }`}
            >
            ...
            <motion.h1
              variants={fadeUp}
              className={`text-3xl sm:text-4xl lg:text-5xl font-serif font-bold tracking-tight leading-[1.15] ${
                isDark ? "text-white" : "text-[#0b1a36]"
              }`}
            >
              Stop guessing <br className="hidden sm:inline" />
              your future. <br />
              <span className="text-[#1E88E5]">Experience it.</span>
            </motion.h1>
            ...
            >
              <button
                ...
                className="group inline-flex items-center justify-center gap-2 bg-[#0b1a36] hover:bg-[#122b59] active:scale-95 text-white font-bold rounded-full px-6 py-3.5 shadow-md shadow-[#0b1a36]/20 transition-all duration-200 text-xs sm:text-sm cursor-pointer"
              >
              ...
              <button
                ...
                className={`inline-flex items-center justify-center gap-2 border font-bold rounded-full px-6 py-3.5 transition-all duration-200 text-xs sm:text-sm active:scale-95 cursor-pointer ${
                  isDark
                    ? "border-slate-800 bg-slate-900/50 hover:bg-slate-800 text-slate-200"
                    : "border-[#D3E3F5] bg-white hover:bg-slate-50 text-[#0b1a36] shadow-xs"
                }`}
              >
            ...
            >
              <h4 className="text-[11px] font-bold tracking-widest uppercase text-amber-600 dark:text-amber-400 mb-3.5">
                BY THE NUMBERS
              </h4>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6 items-start">
                ...
                <div>
                  <p className="text-2xl sm:text-3xl font-extrabold text-[#1E88E5] tracking-tight">
                    500 K
                  </p>
                ...
                <div>
                  <p className="text-2xl sm:text-3xl font-extrabold text-[#7c3aed] tracking-tight">
                    1500+
                  </p>
                  <p className="text-[11px] font-medium leading-tight text-slate-600 dark:text-slate-400 mt-0.5">
                    Careers
        ...
        <motion.button
          ...
          className={`mt-16 flex flex-col items-center gap-1.5 mx-auto text-[10px] font-bold tracking-widest uppercase ${
            isDark ? "text-slate-600 hover:text-slate-400" : "text-slate-400 hover:text-[#0b1a36]"
          } transition`}
        >
...
function EcosystemSection({ isDark }) {
  ...
  return (
    <div className={`py-24 px-6 ${
      isDark ? "bg-slate-950" : "bg-gradient-to-br from-[#f4f8fd] via-[#edf3fb] to-[#dfeaf7]"
    } text-left`}>
      <div className="mx-auto max-w-6xl">
        <div className="text-center mb-16">
          <span className="inline-flex items-center rounded-full border border-sky-200 bg-sky-50 px-3 py-1 text-[11px] font-bold uppercase tracking-[0.2em] text-[#1E88E5] mb-2">
            Target Audience
          </span>
        ...
        >
          {stages.map((stage) => (
            <motion.div
              ...
              whileHover={{ y: -4 }}
              className={`group flex flex-col sm:flex-row rounded-3xl overflow-hidden shadow-xs hover:shadow-md transition-all duration-300 border ${
                isDark
            ...
            >
              ...
              <div className="w-full sm:w-[58%] p-6 sm:p-7 flex flex-col justify-center text-left">
                <h3 className={`text-lg sm:text-xl font-serif font-bold leading-tight mb-2.5 ${
                  isDark ? "text-white" : "text-[#0b1a36]"
                }`}>
                  {stage.title}
                </h3>
...
function TestimonialSlider({ isDark }) {
  ...
  return (
    <div className={`py-16 md:py-24 border-t transition-colors duration-300 ${
      isDark
        ? "bg-[#0b0f19] border-slate-800 text-slate-100"
        : "bg-gradient-to-br from-[#f4f8fd] via-[#edf3fb] to-[#dfeaf7] border-[#D3E3F5] text-[#0b1a36]"
    }`}>
      <div className="mx-auto max-w-6xl px-6 sm:px-8 text-left">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-10">
          ...
          <div className="flex items-center gap-2.5">
            <button
              ...
              className={`p-3 rounded-full border transition-all duration-200 active:scale-95 cursor-pointer ${
                isDark
                  ? "bg-slate-900 border-slate-800 hover:bg-slate-800 text-slate-200"
                  : "bg-white border-[#D3E3F5] hover:bg-slate-50 text-[#0b1a36] shadow-xs"
              }`}
            >
              <ArrowLeft size={16} />
            </button>
              ...
              {TESTIMONIALS.map((_, idx) => (
                <button
                  ...
                  className={`h-2 rounded-full transition-all duration-300 ${
                    curr === idx ? "w-6 bg-[#0b1a36]" : "w-2 bg-[#D3E3F5] dark:bg-slate-700"
                  }`}
                />
              ))}
            </div>
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            exit={{ opacity: 0, y: -15 }}
            transition={{ duration: 0.4 }}
            className={`grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch rounded-3xl p-6 sm:p-10 border ${
              isDark
          ...
          >
            ...
            <div className="lg:col-span-4 flex flex-col justify-between items-center sm:items-start gap-6">
              <div className="relative w-full max-w-[260px] sm:max-w-none aspect-square rounded-2xl overflow-hidden shadow-xs border border-[#D3E3F5] dark:border-slate-800">
                <img
                  src={active.image}
                  alt={active.name}
                  className="w-full h-full object-cover transition-transform duration-500 hover:scale-105"
                />
                <div className="absolute top-3 left-3 bg-white/90 dark:bg-slate-900/90 backdrop-blur-md px-3 py-1 rounded-full border border-[#D3E3F5] dark:border-slate-800 text-[10px] font-bold text-amber-500 flex items-center gap-1 shadow-xs">
                  <span>⭐⭐⭐⭐⭐</span>
                </div>
              </div>

              <div className={`w-full p-4 rounded-2xl border ${
                isDark ? "bg-slate-900/70 border-slate-800" : "bg-[#F0F6FC] border-[#D3E3F5]"
              }`}>
                ...
                <p className={`text-[11px] mt-1 ${isDark ? "text-slate-400" : "text-slate-600"}`}>
                  Matched with <span className="font-semibold text-[#1E88E5]">{active.tag}</span>
                </p>
              </div>
            </div>
            ...
            <div className="lg:col-span-8 flex flex-col justify-between space-y-6 pt-2">
              <div>
                ...
                <p className={`text-base sm:text-lg md:text-xl font-serif leading-relaxed -mt-4 ${
              ...
              <div className="pt-6 border-t border-[#D3E3F5] dark:border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                  <h4 className={`text-base font-bold ${isDark ? "text-white" : "text-[#0b1a36]"}`}>
                    {active.name}
                  </h4>
                ...
                <button
                  onClick={handleNext}
                  className={`flex items-center gap-3 rounded-2xl p-2.5 px-3.5 border transition-all duration-200 text-left active:scale-95 cursor-pointer ${
                    isDark
                      ? "bg-slate-900/80 border-slate-800 hover:bg-slate-800"
                      : "bg-[#F0F6FC] border-[#D3E3F5] hover:bg-white shadow-2xs"
                  }`}
                >
  ...
  return (
    <div
      ...
      className={`relative min-h-[320vh] ${
        isDark ? "bg-[#10141d] text-slate-100" : "bg-gradient-to-br from-[#f4f8fd] via-[#edf3fb] to-[#dfeaf7] text-slate-900"
    ...
    >
      <div className="sticky top-0 h-screen w-full overflow-hidden flex items-center justify-center py-6 px-4 sm:px-8 md:px-12">
        <div className="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-center h-full max-h-[88vh]">
          ...
          {/* Far Left Title Bar */}
          <div className={`hidden xl:flex lg:col-span-1 flex-col items-center justify-center h-full pr-4 border-r ${
            isDark ? "border-slate-800" : "border-[#D3E3F5]"
          }`}>
            <span className={`text-xs font-bold uppercase tracking-[0.25em] -rotate-90 whitespace-nowrap origin-center my-12 ${
              isDark ? "text-slate-500" : "text-slate-500 font-extrabold"
            }`}>
              How it works
            </span>
            <div className={`w-1 flex-1 rounded-full relative my-4 overflow-hidden ${
              isDark ? "bg-slate-800" : "bg-[#D3E3F5]"
            }`}>
              <motion.div
                className="w-full bg-[#0b1a36] dark:bg-amber-500 rounded-full"
                animate={{
                ...
                return (
                  <div
                    ...
                    className={`cursor-pointer transition-all duration-300 ${
                      isActive ? "opacity-100 translate-x-0" : isDark ? "opacity-35 hover:opacity-75" : "opacity-45 hover:opacity-90"
                    }`}
                  >
                    {isActive ? (
                      <motion.div
                      ...
                      >
                        <div className="flex items-center gap-2">
                          <span className="text-xs font-bold text-[#1E88E5] uppercase tracking-widest">
                            {step.num}
                          </span>
                          <span className={`text-xs px-2.5 py-0.5 rounded-full font-bold border ${
                            isDark
                              ? "bg-slate-800 text-slate-300 border-slate-700"
                              : "bg-white text-slate-700 border-[#D3E3F5] shadow-xs"
                          }`}>
                            {step.badge}
                          </span>
                        </div>
                        ...
                        <div className="pt-2 flex flex-wrap items-center gap-3">
                          <button
                            ...
                            className="px-5 py-2.5 rounded-full text-xs font-bold text-white bg-[#0b1a36] hover:bg-[#122b59] shadow-xs active:scale-95 transition-all flex items-center gap-2"
                          >
                          ...
                          <button
                            ...
                            className={`px-4 py-2.5 rounded-full text-xs font-bold border transition-colors flex items-center gap-1 ${
                              isDark
                                ? "text-slate-300 border-slate-700 hover:bg-slate-800"
                                : "text-slate-700 border-[#D3E3F5] bg-white hover:bg-slate-50 shadow-xs"
                            }`}
                          >
                            <span>Blueprint</span>
                      ...
                      <div className="flex items-center gap-3 py-1">
                        ...
                        <span className={`text-xl sm:text-2xl font-serif font-normal ${
                          isDark ? "text-slate-400" : "text-slate-600"
                        }`}>
                          {step.navTitle}
                        </span>
              ...
              >
                ...
                {activeStep === 0 && (
                  <div className="w-full max-w-xl flex flex-col sm:flex-row items-center gap-6">
                    <div className={`w-full sm:w-72 border rounded-3xl p-5 shadow-xs space-y-4 text-left ${
                      isDark ? "bg-[#121315] border-slate-800" : "bg-white border-[#D3E3F5]"
                    }`}>
                      <div className={`flex items-center justify-between pb-2 border-b text-[10px] font-mono ${
                        isDark ? "border-slate-800 text-slate-400" : "border-[#D3E3F5] text-slate-500"
                      }`}>
                        <span>≡ TryYourCareers</span>
                        <span className={`px-2 py-0.5 rounded-full font-bold ${
                          isDark ? "bg-white/10 text-white" : "bg-[#0b1a36] text-white"
                        }`}>Save progress</span>
                      </div>
                      <div className="space-y-1">
                        <span className="text-[10px] text-slate-400 uppercase font-bold block">Would you like to...</span>
                        ...
                        {[
                          ...
                          <div
                            ...
                            className={`p-2.5 rounded-2xl border flex items-center gap-2 transition-all ${
                              opt.active
                                ? "bg-sky-50 border-[#1E88E5] text-[#1E88E5] font-bold"
                                : isDark
                          ...
                          >
                            <span className={`w-4 h-4 rounded border flex items-center justify-center text-[10px] ${
                              isDark ? "border-slate-700" : "border-[#D3E3F5]"
                            }`}>
                              {opt.num}
                            </span>
                            <span>{opt.label}</span>
                    ...
                    <div className={`hidden sm:flex flex-col space-y-4 text-left border-l pl-4 py-2 ${
                      isDark ? "border-slate-800" : "border-[#D3E3F5]"
                    }`}>
                      {[
                        ...
                        <div key={i} className="space-y-1">
                          <div className="flex items-center gap-2 text-xs font-bold">
                            {item.done ? (
                              ...
                              <div className="w-5 h-5 rounded-full bg-slate-300 dark:bg-white border-2 border-slate-300 dark:border-white" />
                            )}
                            <span className={item.active ? isDark ? "text-white text-sm" : "text-slate-900 text-sm font-bold" : isDark ? "text-slate-400" : "text-slate-500"}>{item.label}</span>
                          </div>
                          {item.details && (
                ...
                {activeStep === 1 && (
                  <div className="w-full max-w-lg relative min-h-[320px] flex items-center justify-center">
                    <div className="absolute -top-4 -left-2 sm:left-4 z-20 w-64 p-5 rounded-3xl bg-white border border-[#D3E3F5] text-slate-900 shadow-lg text-left">
                      <span className="text-[9px] font-bold tracking-widest uppercase px-2 py-0.5 rounded-full bg-sky-50 border border-sky-200 text-[#1E88E5]">
                        SUPER RARE • 2% OF USERS
                      </span>
                      <h4 className="font-serif text-lg font-bold mt-2 text-[#0b1a36]">Lucas is a visionary</h4>
                      <p className="text-xs text-slate-500">Creative, Introspective, Persuasive</p>
                    ...
                    <div className="absolute right-2 sm:right-6 top-0 z-10 w-48 h-60 rounded-3xl bg-amber-900/70 border border-amber-500/40 p-4 text-amber-100 flex flex-col justify-between shadow-xl">
                    ...
                    <div className="absolute right-10 bottom-2 z-30 w-44 h-56 rounded-3xl bg-teal-900/90 border border-teal-400/40 p-4 text-teal-100 shadow-2xl flex flex-col justify-between">
                    ...
                    <div className="absolute -bottom-6 right-0 z-40 bg-[#0b1a36] border border-sky-400/30 p-3.5 rounded-2xl max-w-xs text-left text-[11px] text-sky-100 shadow-2xl">
                      ...
                      <span className="text-[9px] text-sky-300 underline block mt-1">Learn about your must-haves →</span>
                    </div>
                  </div>
                )}
                ...
                {activeStep === 2 && (
                  <div className="w-full max-w-lg relative min-h-[320px] flex items-center justify-center">
                    <div className="absolute top-0 left-4 z-10 bg-white text-slate-900 p-3 rounded-2xl shadow-xs border border-[#D3E3F5] flex items-center gap-3">
                    ...
                    <div className="absolute top-14 left-0 z-20 bg-white text-slate-900 p-3 rounded-2xl shadow-xs border border-[#D3E3F5] flex items-center gap-3">
                    ...
                    <div className="absolute top-16 right-20 z-20 bg-[#0b1a36] text-white px-3.5 py-2 rounded-2xl text-left border border-white/10 shadow-lg">
                      <span className="text-[9px] block font-mono text-sky-300">Avg Tuition</span>
                    ...
                    <div className="absolute bottom-0 right-0 z-30 w-72 bg-white text-slate-900 p-4 rounded-3xl shadow-md border border-[#D3E3F5] text-left">
                      <div className="flex items-center justify-between border-b border-[#D3E3F5] pb-2 mb-3">
                        <span className="text-xs font-bold text-slate-900">Filter by average salary</span>
                        <span className="text-[10px] text-slate-400">Avg salary: $56k/yr</span>
                      </div>
                      <div className="flex items-end gap-1 h-12 justify-center mb-2">
                        {[20, 35, 45, 60, 80, 100, 70, 50, 90, 40, 30, 15].map((h, i) => (
                          <div key={i} style={{ height: `${h}%` }} className="w-2 bg-[#1E88E5] rounded-t" />
                        ))}
                      </div>
                      <div className="flex justify-between items-center text-[10px] text-slate-400 pt-2 border-t border-[#D3E3F5]">
                        <span className="px-2 py-1 bg-[#F0F6FC] rounded-lg font-bold text-slate-700">$30,000</span>
                        <span>—</span>
                        <span className="px-2 py-1 bg-[#F0F6FC] rounded-lg font-bold text-slate-700">$300,000</span>
                      </div>
                    </div>

                    <div className="absolute top-36 left-2 z-30 bg-[#0b1a36] text-white px-3 py-1.5 rounded-xl text-left shadow-lg">
                      <span className="text-[9px] block text-sky-300">Avg Salary</span>
                    ...
                    <div className="absolute bottom-8 left-16 z-30 bg-amber-500 text-white px-3 py-1.5 rounded-xl text-left shadow-lg">
                      <span className="text-[9px] block text-amber-100">Growth</span>
                ...
                {activeStep === 3 && (
                  <div className="w-full max-w-lg space-y-4 text-left">
                    <div className={`p-5 rounded-3xl border shadow-xs flex items-start gap-4 ${
                      isDark ? "bg-slate-900 border-slate-800 text-white" : "bg-white border-[#D3E3F5] text-slate-900"
                    }`}>
                      <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=100&auto=format&fit=crop&q=80" alt="Mentor" className="w-11 h-11 rounded-2xl object-cover shrink-0 border border-emerald-400" />
                      <div>
                        <div className="flex items-center gap-2">
                          <span className="text-sm font-bold">Ananya Sharma</span>
                          <span className="text-[10px] px-2 py-0.5 rounded-full bg-emerald-50 text-emerald-700 font-bold border border-emerald-300">
                            Lead UX Architect
                          </span>
                        </div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className={`p-4 rounded-2xl border ${
                        isDark ? "bg-slate-900 border-slate-800 text-white" : "bg-white border-[#D3E3F5] text-slate-900 shadow-xs"
                      }`}>
                        <span className="text-[10px] text-slate-400 uppercase font-bold block">Career Hubs</span>
                        <span className="text-sm font-bold text-emerald-600">128 Active Mentors</span>
                      </div>
                      <div className={`p-4 rounded-2xl border ${
                        isDark ? "bg-slate-900 border-slate-800 text-white" : "bg-white border-[#D3E3F5] text-slate-900 shadow-xs"
                      }`}>
...
function StrideStageModal({ stageId, onClose, isDark }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-black/60 dark:bg-slate-950/85 backdrop-blur-md flex items-center justify-center p-4 sm:p-6 overflow-y-auto font-sans">
      <motion.div
        initial={{ opacity: 0, scale: 0.95 }}
        animate={{ opacity: 1, scale: 1 }}
        exit={{ opacity: 0, scale: 0.95 }}
        className={`relative w-full max-w-5xl rounded-3xl border shadow-2xl p-6 sm:p-8 md:p-10 flex flex-col gap-4 sm:gap-6 transition-colors duration-300 ${
          isDark 
            ? "bg-[#181d2a] border-slate-800 text-slate-100" 
            : "bg-white border-[#D3E3F5] text-slate-800"
        }`}
      >
        <button
          onClick={onClose}
          className={`absolute top-4 right-4 text-slate-400 transition p-2 rounded-full ${
            isDark ? "hover:text-slate-200 hover:bg-slate-800" : "hover:text-slate-600 hover:bg-slate-100"
          }`}
        >
          <X size={18} />
        </button>
          ...
          {[
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 px-3 py-2 sm:px-4 sm:py-2 rounded-full border text-xs font-bold transition-all shadow-xs ${
                  isCurrent
                    ? `bg-[#0b1a36] text-white border-transparent`
                    : isDark
                    ? "bg-[#11151f] border-slate-800/80 text-slate-400 hover:bg-slate-800/50"
                    : "bg-[#F0F6FC] border-[#D3E3F5] text-slate-700 hover:bg-white"
                }`}
              >
        ...
        {!token && (
          <div className={`p-4 rounded-2xl border flex flex-col sm:flex-row items-center justify-between gap-4 transition-colors ${
            ...
            <div className="flex items-center gap-3 text-left">
              <div className="w-10 h-10 rounded-2xl flex items-center justify-center shrink-0 bg-white border border-[#D3E3F5] text-[#1E88E5]">
                <Sparkles size={18} />
              </div>
              <div>
                <p className="text-xs font-bold">Browsing as a Guest</p>
                <p className="text-xs text-slate-600 opacity-90">Create a free account to unlock official tests, get custom job matches, and join hubs.</p>
              </div>
            </div>
            <button
              onClick={() => {
              ...
              className="bg-[#0b1a36] hover:bg-[#122b59] text-white font-bold text-xs px-4 py-2 rounded-full shadow-xs transition-all shrink-0 active:scale-95"
            >
              Sign Up Free
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-8 items-center pt-2">
          <div className="md:col-span-7 space-y-4 text-left">
            <div className="flex items-center gap-3">
              <span className={`inline-flex items-center rounded-full px-3 py-0.5 text-xs font-bold text-white bg-[#0b1a36]`}>
                Stage {stage.num}
              </span>
            ...
            <div className="space-y-1">
              <h3 className={`text-2xl sm:text-3xl font-serif font-bold tracking-tight leading-tight ${
                isDark ? "text-white" : "text-[#0b1a36]"
              }`}>
                {stage.title}
              </h3>
              <p className="text-xs sm:text-sm font-bold text-[#1E88E5]">
                {stage.subtitle}
              </p>
            </div>
            ...
            <div className="space-y-2.5">
              <h4 className="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400">What to expect:</h4>
            ...
            <div className="pt-2">
              <button
                ...
                className="inline-flex items-center gap-2 rounded-full px-5 py-2.5 text-xs font-bold text-white bg-[#0b1a36] hover:bg-[#122b59] active:scale-95 transition-all shadow-xs"
              >
          ...
          <div className="md:col-span-5 flex justify-center w-full mt-4 md:mt-0">
            {demoCompleted && !token ? (
              <div className={`rounded-3xl border p-6 shadow-xs max-w-full sm:max-w-sm w-full text-center space-y-4 ${
                isDark ? "bg-slate-900 border-slate-800 text-slate-100" : "bg-white border-[#D3E3F5] text-slate-800"
              }`}>
                <div className="w-12 h-12 rounded-full bg-emerald-500/10 text-emerald-500 flex items-center justify-center mx-auto">
                  <CheckCircle2 size={24} />
                </div>
                <h4 className="font-serif text-base font-bold">Demo Mission Completed!</h4>
                <p className="text-xs text-slate-500 leading-relaxed">
                  You have completed the interactive preview of {stage.title}. Create a free account to access all features.
                </p>
                <button
                  onClick={() => {
                    onClose();
                  ...
                  className="w-full py-2.5 rounded-full font-bold text-xs text-white bg-[#0b1a36] hover:bg-[#122b59] transition active:scale-95 shadow-xs"
                >
                  Create Free Account
                </button>
              </div>
    ...
    <div className={`p-6 shadow-xs w-full max-w-full sm:max-w-sm space-y-4 text-left rounded-3xl border transition-colors duration-300 ${
      ...
      <div className={`flex items-center justify-between border-b pb-3 transition-colors ${
        ...
        <span className={`h-1.5 w-16 rounded-full relative overflow-hidden ${
          isDark ? "bg-slate-800" : "bg-[#edf3fb]"
        }`}>
          <span className="absolute left-0 top-0 bottom-0 bg-[#0b1a36] transition-all duration-300" style={{ width: `${((qIdx + 1) / 3) * 100}%` }} />
        </span>
      </div>
          ...
          <button
            ...
            className={`w-full text-left p-3 rounded-2xl border text-xs font-semibold transition-all ${
              isDark
                ...
                : "border-[#D3E3F5] bg-[#F0F6FC] text-slate-700 hover:bg-white hover:border-slate-400"
            }`}
          >
            {ans}
          </button>
  ...
  return (
    <div className={`p-6 shadow-xs w-full max-w-full sm:max-w-sm space-y-4 text-left rounded-3xl border transition-colors duration-300 ${
          ...
          <button
            ...
            className={`px-3 py-1 rounded-full text-[10px] font-bold uppercase transition ${
              selected === k
                ...
                : "bg-[#F0F6FC] text-slate-600 hover:bg-white border border-[#D3E3F5]"
            }`}
          >
      ...
      <div className="flex items-center gap-2.5">
        ...
        <div>
          <h4 className="font-serif text-sm font-bold text-slate-900 dark:text-white">{info.name}</h4>
      ...
      <div className="space-y-3 pt-1">
        <div className="space-y-1">
          ...
          <div className={`h-1.5 rounded-full overflow-hidden ${isDark ? "bg-slate-800" : "bg-[#edf3fb]"}`}>
      ...
      <div className={`grid grid-cols-2 gap-3 pt-2 border-t transition-colors ${
        ...
        <div className={`p-2.5 rounded-2xl border text-center transition-colors ${
  ...
  return (
    <div className={`p-5 shadow-xs w-full max-w-full sm:max-w-sm space-y-3.5 text-left font-mono rounded-3xl border transition-colors duration-300 ${
      ...
      <div className={`text-[10px] space-y-1 font-mono transition-colors duration-300 ${
        ...
        <p className="pl-4 text-slate-400 italic"># Fix return value logic</p>
        <p className="pl-4">
      ...
      <div className={`flex justify-between items-center pt-2 border-t text-[10px] transition-colors ${
        ...
        <button
          ...
          className="bg-[#0b1a36] hover:bg-[#122b59] text-white font-bold px-3 py-1.5 rounded-full text-[9px] uppercase font-sans transition disabled:opacity-50"
        >
...
function InteractiveAlign({ onComplete, isDark }) {
  ...
  return (
    <div className={`p-5 shadow-xs w-full max-w-full sm:max-w-sm space-y-3.5 text-left rounded-3xl border transition-colors duration-300 ${
      isDark ? "bg-slate-900 border-slate-800 text-slate-100" : "bg-white border-[#D3E3F5] text-slate-800"
    }`}>
      <div className={`flex items-center justify-between border-b pb-2 transition-colors ${
        isDark ? "border-slate-800" : "border-[#D3E3F5]"
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-bold font-serif">#software-eng-hub</span>
        </div>
        <span className={`text-[9px] px-2 py-0.5 rounded-full font-bold transition-colors ${
          isDark ? "bg-slate-800 text-slate-400" : "bg-sky-50 text-[#1E88E5] border border-sky-200"
        }`}>
          42 Active
        </span>
      </div>
            ...
            <p className={`p-2.5 rounded-2xl transition-colors ${
              msg.isUser
                ? isDark
                  ...
                  : "bg-sky-50 text-[#1E88E5] border border-sky-200"
                : isDark
                ? "bg-slate-850 text-slate-300"
                : "bg-[#F0F6FC] text-slate-700"
            }`}>
              {msg.text}
            </p>
          </div>
      ...
      <div className={`pt-2 border-t space-y-1.5 transition-colors ${
        ...
        <div className="flex flex-col gap-1">
          <button
            ...
            className={`text-[9.5px] text-left px-2.5 py-1.5 rounded-xl border transition disabled:opacity-50 truncate ${
              isDark
                ? "border-slate-800 text-slate-400 hover:bg-emerald-950/20 hover:text-emerald-400"
                : "border-[#D3E3F5] text-slate-600 hover:bg-[#F0F6FC] hover:text-[#0b1a36]"
            }`}
          >
          ...
          <button
            ...
            disabled={isTyping || chat.length > 2}
            className="text-[9.5px] text-left px-2.5 py-1.5 rounded-xl border border-[#D3E3F5] hover:bg-[#F0F6FC] text-slate-600 hover:text-[#0b1a36] transition disabled:opacity-50 truncate"
          >
