  ...
  return (
    <div className="space-y-6" data-testid="developer-workspace">
      <div className="flex flex-wrap items-center justify-between gap-4 rounded-3xl border border-[#E5DEC9] bg-white p-6 shadow-sm">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            <span className="inline-flex items-center gap-1 rounded-full bg-blue-50 border border-blue-200 px-3 py-0.5 text-xs font-bold text-blue-800 uppercase tracking-wider">
              <Activity size={12} /> Developer Investigation Workspace
            </span>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
        {/* LEFT PANEL: Telemetry & Resources */}
        <div className="space-y-4 lg:col-span-3">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="mt-3 pt-2 border-t border-slate-200/60 flex justify-end">
                      ...
                      >
                        <Eye size={12} /> {isAccessed ? "Re-inspect" : "Inspect"}
                      </button>
                    </div>
                  </div>
                );
          ...
          {activeResource && (
            <div className="rounded-3xl border border-emerald-300 bg-emerald-50/40 p-5 shadow-sm space-y-3">
              ...
              <div className="text-xs leading-relaxed text-slate-700 whitespace-pre-wrap max-h-60 overflow-y-auto font-mono">
        ...
        <div className="space-y-6 lg:col-span-6">
          <div className="rounded-3xl border border-[#E5DEC9] bg-white p-6 shadow-sm space-y-3">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-base font-bold text-slate-900">Developer Notes & Diagnostics</h2>
                <p className="text-xs text-slate-500">
                  Private technical scratchpad (autosaved to server).
                </p>
              </div>
            ...
            <textarea
              ...
              placeholder="Record debugging hypotheses, log analysis notes, and stack traces here..."
          ...
          <div className="rounded-3xl border border-[#E5DEC9] bg-white p-6 shadow-sm space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-slate-500">
                  Structured evidence-backed findings submitted for your technical recommendation.
                </p>
              </div>
              {!showFindingForm && (
                <button
              ...
              >
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    placeholder="e.g., PUT /cart/items completed out of order without sequence IDs, overwriting newer state."
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  ...
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      placeholder="e.g. Needs load test verification"
                      className="w-full rounded-xl border border-slate-300 bg-white px-3 py-2 text-xs text-slate-900 focus:border-[#7B4A28] focus:outline-none"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <textarea
                    ...
                    placeholder="Explain the technical evidence and reproduction steps..."
                    className="w-full rounded-xl border border-slate-300 bg-white px-3 py-2 text-xs text-slate-900 focus:border-[#7B4A28] focus:outline-none"
                  />
                </div>
            ...
            {workspaceLoading ? (
              ...
              <div className="rounded-2xl border border-dashed border-slate-300 bg-slate-50/50 p-6 text-center text-xs text-slate-500">
                No findings recorded yet. Inspect logs & code snippets, then click "Add Finding" to capture evidence.
              </div>
            ) : (
              <div className="space-y-3">
                {findings.map((f, idx) => (
                  ...
                  >
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <span className="rounded bg-blue-100 px-1.5 py-0.5 font-mono text-[10px] text-blue-800">
                        Finding #{idx + 1}
                      </span>
                    </div>
        ...
        <div className="space-y-4 lg:col-span-3">
          <div className="rounded-3xl border border-[#E5DEC9] bg-white p-5 shadow-sm space-y-3">
            <div className="flex items-center gap-3 border-b border-slate-100 pb-3">
              ...
              <div>
                <h3 className="text-xs font-bold text-slate-900">{manager.name || "Marcus"}</h3>
                <p className="text-[11px] text-slate-500">{manager.title || "Engineering Lead"}</p>
              </div>
            </div>
            <p className="text-xs leading-relaxed text-slate-600">
              {briefing.task || "Diagnose the race condition, analyze server logs, and record your findings."}
            </p>
          </div>
