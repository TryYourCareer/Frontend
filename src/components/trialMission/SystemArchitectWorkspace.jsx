      ...
      <div className="lg:col-span-3 space-y-5">
        ...
        <div className="rounded-3xl border border-[#E5DEC9] bg-white p-5 shadow-sm space-y-3">
          ...
          <button
            ...
            className="w-full inline-flex items-center justify-center gap-2 rounded-2xl bg-[#7B4A28] py-3 text-sm font-bold text-white shadow-sm transition hover:bg-[#633B20] disabled:opacity-50"
          >
            {completingInvestigation ? (
              <>
